...
export const fetchComments = Mock.mock(import.meta.env.VITE_API_URL + commentUrl['get'](1), "get", 
    ...
    {reviewId:2, userId:1, bookId:1, content:"This is a bad book", rating:1, review_date:"2022-01-02T00:00:00.000Z"},
    {reviewId:3, userId:1, bookId:1, content:"This is a great book", rating:4, review_date:"2022-01-03T00:00:00.000Z"}
    ]  
);